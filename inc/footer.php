        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-auto mb-5"><a class="pe-2 d-flex align-items-center text-decoration-none fw-bold fs-3" href="#">
                <div class="text-warning">Credit Card Fees</div>
              </a></div>
          </div>
          <div class="row flex-center">
            <div class="col-auto mb-5">
              <ul class="list-unstyled list-inline mb-0">
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" aria-current="page" href="index.php">Home</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="https://docs.google.com/forms/d/e/1FAIpQLSdz6h8p1QMDLUQmxFAkNmcYZvpDGcklX5A2vWthCITQHGjBiw/viewform?usp=sf_link">Business Submission</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="contact.php">Contact Me</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="api.php">API</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="faq.php">FAQ</a></li>
				<li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="https://stats.uptimerobot.com/7VjYWCz1E2">Service Status</a></li>
				<!--<li class="list-inline-item me3 me-sm-4"><<a class="text-light text-decoration-none" href="app.php">App</a></li>-->
              </ul>
            </div>
          </div>
          <div class="row flex-center">
